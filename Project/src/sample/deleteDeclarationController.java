...
public class deleteDeclarationController {
    ...
    @FXML
    private TableColumn<Declaration, String> goodsCode;
    ...
    void initialize() {
        ...
        goodsCode.setCellValueFactory(new PropertyValueFactory<>("goodsCode"));
