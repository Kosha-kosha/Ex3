...
public class MainDatabaseHandler extends Configs{
    ...
    public ResultSet getDeclartion() throws SQLException, ClassNotFoundException {
        Declaration declaration = new Declaration();
        //ResultSet resultSet = null;
        Statement stmt = null;
        String select = "SELECT id_declaration, shipper_number, consignee_number, type_declaration, seats, positions, " +
                "payment_method_code, shipper_country_code, consignee_country_code, declarant_number, number_ts, " +
                "gross_weight, net_weight, status, goods_code FROM " + "declaration";
        //try {
